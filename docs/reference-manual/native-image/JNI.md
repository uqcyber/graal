...
A global handle's value is a negative integer that encodes the index of the containing array, the index within the array, and an isolate owner validation tag.
