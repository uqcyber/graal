...
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.FileAttributeMap;
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.FileAttributeValue;
...
abstract class ForeignFileSystem implements ForeignObject, FileSystem {

    @Override
    @ByRemoteReference(ForeignDirectoryStream.class)
    public abstract DirectoryStream<Path> newDirectoryStream(Path dir, @ByLocalReference(ForeignDirectoryStreamFilter.class) Filter<? super Path> filter) throws IOException;

    @Override
    @ByRemoteReference(ForeignSeekableByteChannel.class)
    ...
    @Override
    public abstract void setAttribute(Path path, String attribute, @FileAttributeValue Object value, LinkOption... options) throws IOException;
