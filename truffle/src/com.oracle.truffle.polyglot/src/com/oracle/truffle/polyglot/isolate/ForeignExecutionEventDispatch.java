...
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.PolyglotExceptionReceiver;
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.SourceSectionReceiver;
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.ValueReceiver;

import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.ValuesList;
...
@IsolateDeathHandler(ForeignExecutionEventDispatch.AsCancelledPolyglotException.class)
abstract class ForeignExecutionEventDispatch extends AbstractExecutionEventDispatch {

    ForeignExecutionEventDispatch(AbstractPolyglotImpl polyglot) {
        super(polyglot);
    }

    @Override
    @SourceSectionReceiver
    ...
    @Override
    @PolyglotExceptionReceiver
    public abstract RuntimeException getExecutionEventException(Object impl);

    @CustomDispatchAccessor
    static AbstractExecutionEventDispatch resolveForeignDelegate(Object receiver) {
        return PolyglotIsolateHostSupport.getPolyglot().getManagement().getExecutionEventDispatch(receiver);
    }

    @CustomReceiverAccessor
    static Object resolveReceiver(Object receiver) {
        return PolyglotIsolateHostSupport.getPolyglot().getManagement().getExecutionEventReceiver(receiver);
    }

    @CustomDispatchFactory
    static Object create(ForeignObject receiver) {
        return PolyglotIsolateHostSupport.getPolyglot().getManagement().newExecutionEvent(PolyglotIsolateHostSupport.getExecutionEventDispatch(receiver), receiver);
    }
