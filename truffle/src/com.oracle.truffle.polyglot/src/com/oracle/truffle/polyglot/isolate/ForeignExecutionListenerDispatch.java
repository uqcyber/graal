...
@IsolateDeathHandler(ForeignExecutionListenerDispatch.AsCancelledPolyglotException.class)
abstract class ForeignExecutionListenerDispatch extends AbstractExecutionListenerDispatch {

    ForeignExecutionListenerDispatch(AbstractPolyglotImpl polyglot) {
        super(polyglot);
    }

    @Override
    public final void closeExecutionListener(Object impl) {
        closeExecutionListenerImpl(impl);
        try {
            ((ForeignExecutionListener) impl).hostListener.close();
    ...
    @ReceiverMethod("closeExecutionListener")
    abstract void closeExecutionListenerImpl(Object impl);

    @CustomDispatchAccessor
    static AbstractPolyglotImpl.AbstractExecutionListenerDispatch resolveForeignDelegate(Object receiver) {
        return PolyglotIsolateHostSupport.getPolyglot().getManagement().getExecutionListenerDispatch(receiver);
    }

    @CustomReceiverAccessor
    static Object resolveReceiver(Object receiver) {
        return PolyglotIsolateHostSupport.getPolyglot().getManagement().getExecutionListenerReceiver(receiver);
    }
    ...
    static final class AsCancelledPolyglotException {
        ...
        static void handleIsolateDeath(Object receiver, IsolateDeathException isolateDeath) {
            throw IsolateDeathHandlerSupport.createCancelledPolyglotException(((ForeignExecutionListener) receiver).getForeignEngine(), isolateDeath);
        }
    }
}
