...
abstract class ForeignOutputStream extends OutputStream implements ForeignObject {

    @Override
    public abstract void write(@In(arrayOffsetParameter = "off", arrayLengthParameter = "len") byte[] b, int off, int len) throws IOException;
