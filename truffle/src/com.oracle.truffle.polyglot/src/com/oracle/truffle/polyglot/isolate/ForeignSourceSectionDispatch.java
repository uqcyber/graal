...
@IsolateDeathHandler(IsolateDeathHandlerSupport.AsCancelledPolyglotException.class)
abstract class ForeignSourceSectionDispatch extends AbstractSourceSectionDispatch {

    ForeignSourceSectionDispatch(AbstractPolyglotImpl polyglot) {
        super(polyglot);
    }

    @Override
    public abstract boolean equals(Object impl, @ByRemoteReference(value = ForeignObject.class, useCustomReceiverAccessor = true) Object obj);

    @CustomDispatchAccessor
    static AbstractSourceSectionDispatch resolveForeignDelegate(Object sourceSection) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getSourceSectionDispatch(sourceSection);
    }

    @CustomReceiverAccessor
    static Object resolveReceiver(Object sourceSection) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getSourceSectionReceiver(sourceSection);
    }
}
