...
abstract class ForeignOptionDescriptors implements ForeignObject, OptionDescriptors {

    @Override
    public abstract @ByRemoteReference(ForeignOptionDescriptorIterator.class) Iterator<OptionDescriptor> iterator();

    /**
     * Overridden to become final and not generated by annotation processor. We don't have
     * marshaller for {@code Spliterator<OptionDescriptor>}.
     */
    @Override
    public final Spliterator<OptionDescriptor> spliterator() {
        return OptionDescriptors.super.spliterator();
    }

    /**
     * Overridden to become final and not generated by annotation processor. We don't have
     * marshaller for {@code Consumer<? super OptionDescriptor>}.
     */
    @Override
    public final void forEach(Consumer<? super OptionDescriptor> action) {
        OptionDescriptors.super.forEach(action);
    }
}
