...
abstract class ForeignSourceDispatch extends AbstractSourceDispatch {

    ForeignSourceDispatch(AbstractPolyglotImpl polyglot) {
        super(polyglot);
    }
    ...
    @Override
    @ByRemoteReference(ForeignReader.class)
    ...
    static AbstractSourceDispatch resolveForeignDelegate(Object source) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getSourceDispatch(source);
    }

    @CustomReceiverAccessor
    static Object resolveReceiver(Object source) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getSourceReceiver(source);
    }
}
