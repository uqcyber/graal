...
abstract class ForeignOptionDescriptorIterator implements ForeignObject, Iterator<OptionDescriptor> {
     ...
     */
    @Override
    public final void forEachRemaining(Consumer<? super OptionDescriptor> action) {
