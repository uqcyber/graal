...
import com.oracle.truffle.polyglot.isolate.PolyglotMarshallerConfig.SourceReceiver;
...
abstract class ForeignSourcePredicate implements ForeignObject, Predicate<Object> {

    @Override
    public abstract boolean test(@SourceReceiver Object o);

    @Override
    public final Predicate<Object> and(Predicate<? super Object> other) {
    ...
    @Override
    public final Predicate<Object> or(Predicate<? super Object> other) {
