...
abstract class ForeignPathIterator implements ForeignObject, Iterator<Path> {

    @Override
    @ByRemoteReference(ForeignPath.class)
    public abstract Path next();

    /**
     * Overridden to become final and not generated by annotation processor. All filesystem
     * implementations use the default implementation. We don't need to bridge the Consumer
     * interface.
     */
    @Override
    public final void forEachRemaining(Consumer<? super Path> action) {
