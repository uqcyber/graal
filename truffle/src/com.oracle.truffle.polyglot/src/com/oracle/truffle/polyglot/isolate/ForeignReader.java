...
abstract class ForeignReader extends Reader implements ForeignObject {

    @Override
    public abstract int read(@Out(arrayOffsetParameter = "off", arrayLengthParameter = "len", trimToResult = true) char[] cbuff, int off, int len) throws IOException;
    ...
    @Override
    public final long transferTo(Writer out) throws IOException {
        return super.transferTo(out);
    }

    @SuppressWarnings("all")
    public final String readAllAsString() throws IOException {
