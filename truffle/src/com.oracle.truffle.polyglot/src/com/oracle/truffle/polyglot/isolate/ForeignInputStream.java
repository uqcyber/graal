...
@IsolateDeathHandler(IsolateDeathHandlerSupport.AsCancelledOrPolyglotException.class)
abstract class ForeignInputStream extends InputStream implements ForeignObject {

    @Override
    public abstract int read(@Out(arrayOffsetParameter = "off", arrayLengthParameter = "len", trimToResult = true) byte[] b, int off, int len) throws IOException;
