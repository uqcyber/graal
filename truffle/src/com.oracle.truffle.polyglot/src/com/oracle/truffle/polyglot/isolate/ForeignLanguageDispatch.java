...
@IsolateDeathHandler(ForeignLanguageDispatch.AsCancelledPolyglotException.class)
abstract class ForeignLanguageDispatch extends AbstractLanguageDispatch {

    ForeignLanguageDispatch(AbstractPolyglotImpl polyglot) {
        super(polyglot);
    }
    ...
    static AbstractLanguageDispatch resolveForeignDelegate(Object language) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getLanguageDispatch(language);
    }

    @CustomReceiverAccessor
    static Object resolveReceiver(Object language) {
        return PolyglotIsolateHostSupport.getPolyglot().getAPIAccess().getLanguageReceiver(language);
    }
    ...
    static final class AsCancelledPolyglotException {
        ...
        static void handleIsolateDeath(Object receiver, IsolateDeathException isolateDeath) {
            throw IsolateDeathHandlerSupport.createCancelledPolyglotException(((ForeignLanguage) receiver).getForeignEngine(), isolateDeath);
        }
    }
}
