...
abstract class ForeignExecutionEventConsumer implements ForeignObject, Consumer<Object> {

    @Override
    public abstract void accept(@ByLocalReference(ForeignExecutionEventDispatch.class) Object event);

    @Override
    public final Consumer<Object> andThen(Consumer<? super Object> after) {
