...
abstract class ForeignStringPredicate implements ForeignObject, Predicate<String> {

    @Override
    public final Predicate<String> and(Predicate<? super String> other) {
    ...
    @Override
    public final Predicate<String> or(Predicate<? super String> other) {
