...
abstract class ForeignMessageTransport implements ForeignObject, MessageTransport {

    @Override
    @ByRemoteReference(ForeignMessageEndpoint.class)
    public abstract MessageEndpoint open(URI uri, @ByLocalReference(ForeignMessageEndpoint.class) MessageEndpoint peerEndpoint) throws IOException, VetoException;
}
