...
abstract class ForeignOptionValidator implements ForeignObject, Consumer<Object> {

    @Override
    public abstract void accept(@OptionValue Object o);

    /**
     * Overridden to become final and not generated by annotation processor. We don't have
     * marshaller for {@code Consumer<? super Object>}.
     */
    @Override
