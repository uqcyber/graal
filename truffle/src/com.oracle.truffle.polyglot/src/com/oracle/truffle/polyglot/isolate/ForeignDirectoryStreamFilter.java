...
@IsolateDeathHandler(IsolateDeathHandlerSupport.AsIOException.class)
abstract class ForeignDirectoryStreamFilter implements ForeignObject, Filter<Path> {

    @Override
    public abstract boolean accept(@ByLocalReference(ForeignPath.class) Path entry) throws IOException;
}
