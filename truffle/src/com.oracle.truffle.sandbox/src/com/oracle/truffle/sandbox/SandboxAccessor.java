...
final class SandboxAccessor extends Accessor {

    static final SandboxAccessor ACCESSOR = new SandboxAccessor();
    static final RuntimeSupport RUNTIME = ACCESSOR.runtimeSupport();

    static final class SandboxSupportImpl extends SandboxSupport {
