...
3. Clone the [`mx` repository](https://github.com/graalvm/mx):
    ...
    ```
4. Check the `mx` version defined in the [Graal CI](../common.json). Currently it is on `"mx_version": "7.78.0"`. Then check the one you cloned:
    ```bash
    mx/mx --version
    ```
