...
public final class CRC32CUpdateBytesNode extends PureFunctionStubIntrinsicNode {
    public static final NodeClass<CRC32CUpdateBytesNode> TYPE = NodeClass.create(CRC32CUpdateBytesNode.class);

    public static final ForeignCallDescriptor STUB = ForeignCalls.pureFunctionForeignCallDescriptor("updateBytesCRC32C", int.class,
    ...
    public CRC32CUpdateBytesNode(ValueNode crc, ValueNode bufferAddress, ValueNode length) {
        this(crc, bufferAddress, length, null);
    }

    public CRC32CUpdateBytesNode(ValueNode crc, ValueNode bufferAddress, ValueNode length, EnumSet<?> runtimeCheckedCPUFeatures) {
    ...
    public static EnumSet<AMD64.CPUFeature> minFeaturesAMD64() {
        return EnumSet.of(SSE4_2, CLMUL);
    }

    public static EnumSet<AMD64.CPUFeature> maxFeaturesAMD64() {
        return EnumSet.of(SSE4_2, CLMUL, AVX, AVX2, AVX512F, AVX512DQ, AVX512BW, AVX512VL, AVX512_VPCLMULQDQ);
    }

    public static EnumSet<AArch64.CPUFeature> minFeaturesAARCH64() {
        return EnumSet.of(AArch64.CPUFeature.CRC32);
    }
    ...
    public void emitIntrinsic(NodeLIRBuilderTool gen) {
        var result = gen.getLIRGeneratorTool().emitCRC32CUpdateBytes(getRuntimeCheckedCPUFeatures(), gen.operand(crc), gen.operand(bufferAddress), gen.operand(length));
