...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersRP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersRRR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersRRRZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersRZP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersZP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifyRegistersZRP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersFF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersFFF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersFFFF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersFZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersPP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersPPZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersPR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersPZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersRF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersRR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersRRR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersRZR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersRZZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersZP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersZZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeAndRegistersZZZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizeRegistersZPZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizesAndRegistersFZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Asserts.verifySizesAndRegistersRF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADC;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADCS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADD;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADDS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ADRP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.AND;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ANDS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ASRV;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BFM;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BIC;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BICS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BLR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.BRK;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.CAS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.CCMP;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.DC;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.DMB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.DSB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.EON;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.EOR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.EXTR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FABS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FADD;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCCMP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCMP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCMPZERO;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCSEL;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCVT2D;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCVT2H;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FCVT2S;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FMIN;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FMOV;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FMSUB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FMUL;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FNEG;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FRINTM;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FRINTN;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FRINTP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FRINTZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FSQRT;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.FSUB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.HINT;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.HLT;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ISB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDADD;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDAR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDAXR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDP;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDRS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LDXR;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LSLV;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.LSRV;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MADD;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MOVK;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MOVN;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MOVZ;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MRS;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.MSUB;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.ORN;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.SCVTF;
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.SDIV;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.Instruction.SWP;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Assembler.InstructionType.General32;
