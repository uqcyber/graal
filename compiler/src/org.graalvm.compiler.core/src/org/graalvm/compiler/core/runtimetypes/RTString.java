...
public class RTString extends RTInstance{
    ...
    public RTString(ResolvedJavaType type, String string){
        ...
        //todo how to get String into resolvedJavaType form? Currently passing type through metaContext
        ...
        for (ResolvedJavaField field: type.getInstanceFields(true)) {
            ...
            if (field.getName().equals("value")){ // Overwrites the "value" field with the RTArray of chars.
