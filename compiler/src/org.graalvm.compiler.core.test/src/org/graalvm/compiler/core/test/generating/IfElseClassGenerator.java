 ...
 */
public class IfElseClassGenerator extends Generator<byte[]> {
    ...
    private void generateOps(SourceOfRandomness r, InsnList il, int slots) {
        if (!remainingLocals.isEmpty()) {
            ...
            il.add(new JumpInsnNode(generateJumpInstr(r), jmpLabel));
