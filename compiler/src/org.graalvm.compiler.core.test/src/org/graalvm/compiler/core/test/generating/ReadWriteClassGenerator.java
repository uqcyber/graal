 ...
 */
public class ReadWriteClassGenerator extends Generator<byte[]> {
    ...
    public ReadWriteClassGenerator() {
        super(byte[].class);
    }
    ...
    private void generateMethod(ClassNode cn, SourceOfRandomness r) {
        ...
        String methodName = "qwer";
        MethodNode mn = new MethodNode(flags, methodName, "()I", null, null);
    ...
    private void generateOps(SourceOfRandomness r, InsnList il, int slots) {
        generateReadStaticField(il, "example/D", "MY_STATIC_FIELD");

        // ... (rest of the method generation logic)

        // Write a value to the static field at the end of the method.
        il.add(new IntInsnNode(Opcodes.BIPUSH, r.nextInt())); // Pushing the integer 42 onto the stack
        generateWriteStaticField(il, "example/D", "MY_STATIC_FIELD");
        while (r.nextBoolean()) {
    ...
    private void generateReadStaticField(InsnList il, String className, String fieldName) {
        il.add(new FieldInsnNode(Opcodes.GETSTATIC, className, fieldName, "I"));
    }
    private void generateWriteStaticField(InsnList il, String className, String fieldName) {
        il.add(new FieldInsnNode(Opcodes.PUTSTATIC, className, fieldName, "I"));
    }
