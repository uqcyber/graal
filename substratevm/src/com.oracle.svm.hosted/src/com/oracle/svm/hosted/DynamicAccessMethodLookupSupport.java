...
public class DynamicAccessMethodLookupSupport {
    ...
    public static DynamicAccessMethodLookupSupport instance() {
        return ImageSingletons.lookup(DynamicAccessMethodLookupSupport.class);
    }

    public DynamicAccessMethodLookupSupport(AnalysisMetaAccess metaAccess) {
