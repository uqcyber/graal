...
public interface ForeignHostedSupport {
    ...
    MethodHandleWithExceptionPlugin createHandleWithExceptionPlugin(MethodHandleAccessProvider methodHandleAccess);

    ResolvedJavaMethod resolveDowncallStub(JavaConstant nativeEntryPoint);
}
