...
interface ReflectionMetadata {
    ...
    Field[] getDeclaredFields(DynamicHub declaringClass, boolean publicOnly, int layerNum);

    Method[] getDeclaredMethods(DynamicHub declaringClass, boolean publicOnly, int layerNum);
