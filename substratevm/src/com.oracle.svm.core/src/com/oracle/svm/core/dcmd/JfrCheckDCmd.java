...
public class JfrCheckDCmd extends AbstractJfrDCmd {
    ...
    protected Target_jdk_jfr_internal_dcmd_AbstractDCmd createDCmd() {
        return SubstrateUtil.cast(new Target_jdk_jfr_internal_dcmd_DCmdCheck(), Target_jdk_jfr_internal_dcmd_AbstractDCmd.class);
    }
}

@TargetClass(className = "jdk.jfr.internal.dcmd.DCmdCheck")
final class Target_jdk_jfr_internal_dcmd_DCmdCheck {
    @Alias
    Target_jdk_jfr_internal_dcmd_DCmdCheck() {
    }
}
